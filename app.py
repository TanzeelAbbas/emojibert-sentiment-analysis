...
with gr.Blocks(title="Emoji-based Sentiment Analysis", theme=gr.themes.Soft()) as demo:
    ...
    gr.Markdown(
        """
        # ✈️ Airline Sentiment Analysis with Emoji Support
        
        This model analyzes airline reviews and incorporates **emojis and emoticons** for more accurate sentiment detection.
        ...
        **Accuracy:** 92% (9% improvement over baseline models)
        """
    )
    ...
    with gr.Row():
        with gr.Column():
            text_input = gr.Textbox(
                label="Enter your airline review",
                placeholder="Type or paste your review here... Feel free to use emojis! 😊✈️",
                lines=4
            )
